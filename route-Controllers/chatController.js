...
const renameGroup = asyncHandler(async(req,res)=>{
    ...
    const updateChatName = await Chat.findByIdAndUpdate(chatId,{chatName},{new:true}
...
const addToGroup = asyncHandler(async(req,res)=>{
  const { chatId ,userId} = req.body;
    ...
    const addToGroup = await Chat.findByIdAndUpdate(chatId,{$push:{users:userId}},{new:true}
        ).populate("users","-password").populate("groupAdmin","-password");
...
const removeFromGroup = asyncHandler(async(req,res)=>{
    ...
    const removeFromGroup = await Chat.findByIdAndUpdate(chatId,{$pull:{users:userId}},{new:true}
        ).populate("users","-password").populate("groupAdmin","-password");
